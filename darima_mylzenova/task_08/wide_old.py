...
class MnistBatch_old(ImagesBatch):
    ...
    def resnet(self, config):
        ...
        with tf.Graph().as_default():
            ...
            net1 = conv_block(net1, 3, [16, 16], name='22', strides=(1, 1), initializer=conv_initializer, w_factor=widening_factor)
            ...
            net1 = conv_block(net1, 3, [32, 32], name='33', strides=(1, 1), initializer=conv_initializer, w_factor=widening_factor)
            ...
            net1 = conv_block(net1, 3, [64, 64], name='63', strides=(1, 1), initializer=conv_initializer, w_factor=widening_factor)
    ...
    @action(model='resnet')
    def train_res(self, models, train_loss, accs, data, lables, time_list):
