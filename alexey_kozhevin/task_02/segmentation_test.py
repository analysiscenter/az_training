...
def _binary_iou(masks, predictions, data_format='channels_last'):
...
def demonstrate_model(model, mnistset, data_format='channels_last'):
    ...
    placeholders_config = {'images': {'shape': shape,
                                      'type': 'float32',
    ...
    model_config = {'inputs': placeholders_config,
                    ...
                    'loss': 'ce' if data_format == 'channels_last' else _loss,
                    'optimizer': 'Adam'}
    ...
    iou = _binary_iou(masks, predictions, data_format)
