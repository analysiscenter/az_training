...
class FCNModel(NetworkModel):
    ...
    def _build(self, inputs, *args, **kwargs):
        ...
        net = VGGModel.fully_conv_block(dim, inputs['images'], b_norm, 'VGG16', **kwargs)
        net = conv_block(dim, net, 100, 7, 'ca', 'conv-out-1', **kwargs)
        net = conv_block(dim, net, 100, 1, 'ca', 'conv-out-2', padding='VALID', **kwargs)
